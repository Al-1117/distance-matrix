...
$(document).ready(function () {
  ...
  $('.test').on('click', function () {
    $.ajax({
      ...
      success: function success(response) {
        ...
        printHomeData(response, homeTemplate); // Se si dovessero presentare errori...
      },
  ...
  function printHomeData(response, printTemplate) {
    ...
    var template = Handlebars.compile(source); // Definisco i dati che mi servono per la succesiva stampa

    for (var i = 0; i < response.result.length; i++) {
      console.log(response);
      var thisItem = response.result[i].elements[i];
      console.log(thisItem.distance.text); // Compilo il contesto
...
__webpack_require__(/*! /Users/alioune_pen/Desktop/exercises/pratic/distance_matrix/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/alioune_pen/Desktop/exercises/pratic/distance_matrix/resources/sass/app.scss */"./resources/sass/app.scss");
